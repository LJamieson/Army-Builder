...
public class TabEliteFragment extends Fragment {
    private static final String TAG = "TabEliteFragment";

    // Declare all of the items from the layout
    private Button EliteCal;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.elite_fragment,container,false);
        EliteCal = (Button) view.findViewById(R.id.Elite_Cal);

        BtnSave = (Button) view.findViewById(R.id.EliteSave);
        BtnLoad = (Button) view.findViewById(R.id.EliteLoad);

        UnitName1 = (EditText) view.findViewById(R.id.UnitElite_Name1); UnitName2 = (EditText) view.findViewById(R.id.UnitElite_Name2);
        UnitWS1 = (EditText) view.findViewById(R.id.UnitElite_WS1); UnitWS2 = (EditText) view.findViewById(R.id.UnitElite_WS2);
        UnitBS1 = (EditText) view.findViewById(R.id.UnitElite_BS1); UnitBS2 = (EditText) view.findViewById(R.id.UnitElite_BS2);
        UnitS1 = (EditText) view.findViewById(R.id.UnitElite_S1); UnitS2 = (EditText) view.findViewById(R.id.UnitElite_S2);
        UnitT1 = (EditText) view.findViewById(R.id.UnitElite_T1); UnitT2 = (EditText) view.findViewById(R.id.UnitElite_T2);
        UnitW1 = (EditText) view.findViewById(R.id.UnitElite_W1); UnitW2 = (EditText) view.findViewById(R.id.UnitElite_W2);
        UnitI1 = (EditText) view.findViewById(R.id.UnitElite_I1); UnitI2 = (EditText) view.findViewById(R.id.UnitElite_I2);
        UnitA1 = (EditText) view.findViewById(R.id.UnitElite_A1); UnitA2 = (EditText) view.findViewById(R.id.UnitElite_A2);
        UnitLd1 = (EditText) view.findViewById(R.id.UnitElite_Ld1); UnitLd2 = (EditText) view.findViewById(R.id.UnitElite_Ld2);
        UnitSv1 = (EditText) view.findViewById(R.id.UnitElite_Sv1); UnitSv2 = (EditText) view.findViewById(R.id.UnitElite_Sv2);
        UnitNotes1 = (EditText) view.findViewById(R.id.UnitElite_Note1); UnitNotes2 = (EditText) view.findViewById(R.id.UnitElite_Note2);
        UnitPoint1 = (EditText) view.findViewById(R.id.UnitElitePoints1); UnitPoint2 = (EditText) view.findViewById(R.id.UnitElitePoints2);

        VehicleName1 = (EditText) view.findViewById(R.id.VehicleElite_Name1);
        VehicleF1 = (EditText) view.findViewById(R.id.VehicleElite_F1);
        VehicleS1 = (EditText) view.findViewById(R.id.VehicleElite_S1);
        VehicleR1 = (EditText) view.findViewById(R.id.VehicleElite_R1);
        VehicleBS1 = (EditText) view.findViewById(R.id.VehicleElite_BS1);
        VehicleNotes1 = (EditText) view.findViewById(R.id.VehicleElite_Note1);
        VehiclePoint1 = (EditText) view.findViewById(R.id.VehicleElitePoints1);

        WeaponName1 = (EditText) view.findViewById(R.id.WeapElite_Name1); WeaponName2 = (EditText) view.findViewById(R.id.WeapElite_Name2);
        WeaponName3 = (EditText) view.findViewById(R.id.WeapElite_Name3);
        WeaponR1 = (EditText) view.findViewById(R.id.WeapElite_R1); WeaponR2 = (EditText) view.findViewById(R.id.WeapElite_R2);
        WeaponR3 = (EditText) view.findViewById(R.id.WeapElite_R3);
        WeaponS1 = (EditText) view.findViewById(R.id.WeapElite_S1); WeaponS2 = (EditText) view.findViewById(R.id.WeapElite_S2);
        WeaponS3 = (EditText) view.findViewById(R.id.WeapElite_S3);
        WeaponAP1 = (EditText) view.findViewById(R.id.WeapElite_AP1); WeaponAP2 = (EditText) view.findViewById(R.id.WeapElite_AP2);
        WeaponAP3 = (EditText) view.findViewById(R.id.WeapElite_AP3);
        WeaponT1 = (EditText) view.findViewById(R.id.WeapElite_T1); WeaponT2 = (EditText) view.findViewById(R.id.WeapElite_T2);
        WeaponT3 = (EditText) view.findViewById(R.id.WeapElite_T3);
        WeaponNote1 = (EditText) view.findViewById(R.id.WeapElite_Note1); WeaponNote2 = (EditText) view.findViewById(R.id.WeapElite_Note2);
        WeaponNote3 = (EditText) view.findViewById(R.id.WeapElite_Note3);
        WeaponPoint1 = (EditText) view.findViewById(R.id.WeapElitePoints1); WeaponPoint2 = (EditText) view.findViewById(R.id.WeapElitePoints2);
        WeaponPoint3 = (EditText) view.findViewById(R.id.WeapElitePoints3);
        TotalPoint = (TextView) view.findViewById(R.id.total_Elite_points);

        WalkerName1= (EditText) view.findViewById(R.id.WalkElite_Name1);
        WalkerWS1= (EditText) view.findViewById(R.id.WalkElite_WS1);
        WalkerBS1= (EditText) view.findViewById(R.id.WalkElite_BS1);
        WalkerS1= (EditText) view.findViewById(R.id.WalkElite_S1);
        WalkerF1= (EditText) view.findViewById(R.id.WalkElite_F1);
        WalkerSide= (EditText) view.findViewById(R.id.WalkElite_Side1);
        WalkerR1= (EditText) view.findViewById(R.id.WalkElite_R1);
        WalkerI1= (EditText) view.findViewById(R.id.WalkElite_I1);
        WalkerA1= (EditText) view.findViewById(R.id.WalkElite_A1);
        WalkerNote1= (EditText) view.findViewById(R.id.WalkElite_Note1);
        WalkerPoint1= (EditText) view.findViewById(R.id.WalkElitePoints1);
        ...
        BtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    File file = new File(getActivity().getExternalFilesDir(null), "Elite_ArmyList.txt");

                    try {
                        OutputStream os = new FileOutputStream(file);
                        os.write(data.getBytes());
                        os.close();
                        Toast.makeText(getContext(),"Elite saved",Toast.LENGTH_SHORT).show();
        ...
        BtnLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Environment.MEDIA_MOUNTED.equals(state)) {
                    ...
                    File file = new File(getContext().getExternalFilesDir(null), "Elite_ArmyList.txt");
                    ...
                    {
                        Toast.makeText(getContext(), "Elite does not exist", Toast.LENGTH_SHORT).show();
                    }
        ...
        EliteCal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                {
                    UnitElite_P1 = Integer.parseInt(String.valueOf(UnitPoint1.getText()));
                }
                int UnitElite_P2;
                ...
                {
                    UnitElite_P2 = Integer.parseInt(String.valueOf(UnitPoint2.getText()));
                }
                int Vehicle_P1;
                ...
                {
                    WeapElite_P1 = Integer.parseInt(String.valueOf(WeaponPoint1.getText()));
                }
                int WeapElite_P2;
                ...
                {
                    WeapElite_P2 = Integer.parseInt(String.valueOf(WeaponPoint2.getText()));
                }
                int WeapElite_P3;
                ...
                {
                    WeapElite_P3 = Integer.parseInt(String.valueOf(WeaponPoint3.getText()));
                }
                int WalkElite_P1;
                ...
                {
                    WalkElite_P1 = Integer.parseInt(String.valueOf(WalkerPoint1.getText()));
                }

                int Total = UnitElite_P1 + UnitElite_P2 + Vehicle_P1 + WeapElite_P1 + WeapElite_P2 + WeapElite_P3 + WalkElite_P1;
