...
public class TabFastFragment extends Fragment {
    private static final String TAG = "TabFastFragment";

    // Declare all of the items from the layout
    private Button FastCal;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fast_fragment,container,false);

        FastCal = (Button) view.findViewById(R.id.Fast_Cal);

        BtnSave = (Button) view.findViewById(R.id.FastSave);
        BtnLoad = (Button) view.findViewById(R.id.FastLoad);

        UnitName1 = (EditText) view.findViewById(R.id.UnitFast_Name1); UnitName2 = (EditText) view.findViewById(R.id.UnitFast_Name2);
        UnitWS1 = (EditText) view.findViewById(R.id.UnitFast_WS1); UnitWS2 = (EditText) view.findViewById(R.id.UnitFast_WS2);
        UnitBS1 = (EditText) view.findViewById(R.id.UnitFast_BS1); UnitBS2 = (EditText) view.findViewById(R.id.UnitFast_BS2);
        UnitS1 = (EditText) view.findViewById(R.id.UnitFast_S1); UnitS2 = (EditText) view.findViewById(R.id.UnitFast_S2);
        UnitT1 = (EditText) view.findViewById(R.id.UnitFast_T1); UnitT2 = (EditText) view.findViewById(R.id.UnitFast_T2);
        UnitW1 = (EditText) view.findViewById(R.id.UnitFast_W1); UnitW2 = (EditText) view.findViewById(R.id.UnitFast_W2);
        UnitI1 = (EditText) view.findViewById(R.id.UnitFast_I1); UnitI2 = (EditText) view.findViewById(R.id.UnitFast_I2);
        UnitA1 = (EditText) view.findViewById(R.id.UnitFast_A1); UnitA2 = (EditText) view.findViewById(R.id.UnitFast_A2);
        UnitLd1 = (EditText) view.findViewById(R.id.UnitFast_Ld1); UnitLd2 = (EditText) view.findViewById(R.id.UnitFast_Ld2);
        UnitSv1 = (EditText) view.findViewById(R.id.UnitFast_Sv1); UnitSv2 = (EditText) view.findViewById(R.id.UnitFast_Sv2);
        UnitNotes1 = (EditText) view.findViewById(R.id.UnitFast_Note1); UnitNotes2 = (EditText) view.findViewById(R.id.UnitFast_Note2);
        UnitPoint1 = (EditText) view.findViewById(R.id.UnitFastPoints1); UnitPoint2 = (EditText) view.findViewById(R.id.UnitFastPoints2);

        VehicleName1 = (EditText) view.findViewById(R.id.VehicleFast_Name1);
        VehicleF1 = (EditText) view.findViewById(R.id.VehicleFast_F1);
        VehicleS1 = (EditText) view.findViewById(R.id.VehicleFast_S1);
        VehicleR1 = (EditText) view.findViewById(R.id.VehicleFast_R1);
        VehicleBS1 = (EditText) view.findViewById(R.id.VehicleFast_BS1);
        VehicleNotes1 = (EditText) view.findViewById(R.id.VehicleFast_Note1);
        VehiclePoint1 = (EditText) view.findViewById(R.id.VehicleFastPoints1);

        WeaponName1 = (EditText) view.findViewById(R.id.WeapFast_Name1); WeaponName2 = (EditText) view.findViewById(R.id.WeapFast_Name2);
        WeaponName3 = (EditText) view.findViewById(R.id.WeapFast_Name3); WeaponName4 = (EditText) view.findViewById(R.id.WeapFast_Name4);
        WeaponR1 = (EditText) view.findViewById(R.id.WeapFast_R1); WeaponR2 = (EditText) view.findViewById(R.id.WeapFast_R2);
        WeaponR3 = (EditText) view.findViewById(R.id.WeapFast_R3); WeaponR4 = (EditText) view.findViewById(R.id.WeapFast_R4);
        WeaponS1 = (EditText) view.findViewById(R.id.WeapFast_S1); WeaponS2 = (EditText) view.findViewById(R.id.WeapFast_S2);
        WeaponS3 = (EditText) view.findViewById(R.id.WeapFast_S3); WeaponS4 = (EditText) view.findViewById(R.id.WeapFast_S4);
        WeaponAP1 = (EditText) view.findViewById(R.id.WeapFast_AP1); WeaponAP2 = (EditText) view.findViewById(R.id.WeapFast_AP2);
        WeaponAP3 = (EditText) view.findViewById(R.id.WeapFast_AP3); WeaponAP4 = (EditText) view.findViewById(R.id.WeapFast_AP4);
        WeaponT1 = (EditText) view.findViewById(R.id.WeapFast_T1); WeaponT2 = (EditText) view.findViewById(R.id.WeapFast_T2);
        WeaponT3 = (EditText) view.findViewById(R.id.WeapFast_T3); WeaponT4 = (EditText) view.findViewById(R.id.WeapFast_T4);
        WeaponNote1 = (EditText) view.findViewById(R.id.WeapFast_Note1); WeaponNote2 = (EditText) view.findViewById(R.id.WeapFast_Note2);
        WeaponNote3 = (EditText) view.findViewById(R.id.WeapFast_Note3); WeaponNote4 = (EditText) view.findViewById(R.id.WeapFast_Note4);
        WeaponPoint1 = (EditText) view.findViewById(R.id.WeapFastPoints1); WeaponPoint2 = (EditText) view.findViewById(R.id.WeapFastPoints2);
        WeaponPoint3 = (EditText) view.findViewById(R.id.WeapFastPoints3); WeaponPoint4 = (EditText) view.findViewById(R.id.WeapFastPoints4);
        TotalPoint = (TextView) view.findViewById(R.id.total_Fast_points);
        ...
        BtnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    File file = new File(getActivity().getExternalFilesDir(null), "Fast_ArmyList.txt");

                    try {
                        OutputStream os = new FileOutputStream(file);
                        os.write(data.getBytes());
                        os.close();
                        Toast.makeText(getContext(),"Fast Attack saved",Toast.LENGTH_SHORT).show();
        ...
        BtnLoad.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Environment.MEDIA_MOUNTED.equals(state)) {
                    ...
                    File file = new File(getContext().getExternalFilesDir(null), "Fast_ArmyList.txt");
                    ...
                    {
                        Toast.makeText(getContext(), "Fast Attack does not exist", Toast.LENGTH_SHORT).show();
                    }
        ...
        FastCal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                {
                    UnitFast_P1 = Integer.parseInt(String.valueOf(UnitPoint1.getText()));
                }
                int UnitFast_P2;
                ...
                {
                    UnitFast_P2 = Integer.parseInt(String.valueOf(UnitPoint2.getText()));
                }
                int Vehicle_P1;
                ...
                {
                    WeapFast_P1 = Integer.parseInt(String.valueOf(WeaponPoint1.getText()));
                }
                int WeapFast_P2;
                ...
                {
                    WeapFast_P2 = Integer.parseInt(String.valueOf(WeaponPoint2.getText()));
                }
                int WeapFast_P3;
                ...
                {
                    WeapFast_P3 = Integer.parseInt(String.valueOf(WeaponPoint3.getText()));
                }
                int WeapFast_P4;
                ...
                {
                    WeapFast_P4 = Integer.parseInt(String.valueOf(WeaponPoint4.getText()));
                }

                int Total = UnitFast_P1 + UnitFast_P2 + Vehicle_P1 + WeapFast_P1 + WeapFast_P2 + WeapFast_P3 + WeapFast_P4;
